...
## 2026-04-14 - Limpeza de produtos/tabelas/conte˙dos

- Banco zerado para `products`, `commission_tables` e `contents`.
- Contagens apÛs limpeza: `products=0`, `commission_tables=0`, `contents=0`.
- Tabela `users` mantida sem alteraÁıes.
...
## 2026-04-14 - Bot„o Atualizar na lista de usu·rios

- Adicionado bot„o `Atualizar` no mÛdulo de usu·rios sem recarregar a p·gina.
- AtualizaÁ„o chama `GET /api/users` e recarrega apenas a tabela de usu·rios.
...
## 2026-04-14 - Ajuste visual do bot„o Atualizar em usu·rios

- Bot„o `Atualizar` ficou menor e com background no padr„o dos botıes de aÁ„o.
...
## 2026-04-14 - Filtro e pesquisa na lista de usu·rios

- Adicionado filtro por status ao lado do bot„o `Atualizar` no mÛdulo de usu·rios.
- Adicionado campo de pesquisa alinhado ‡ direita abaixo do tÌtulo `Usu·rios`.
...
## 2026-04-14 - Ajuste de alinhamento no toolbar de usu·rios

- Removido texto `Status` no filtro.
- Campo de pesquisa realinhado para esquerda abaixo do tÌtulo `Usu·rios`.
- Filtro e bot„o `Atualizar` mantidos lado a lado ‡ direita.
...
## 2026-04-14 - CorreÁ„o final de alinhamento no toolbar de usu·rios

- Toolbar de usu·rios expandida para largura total do card.
- Filtro + Atualizar fixados ‡ direita com `margin-left: auto`.
- Busca mantida abaixo do tÌtulo ‡ esquerda.
