...
## 2026-04-14 - Usu�rios: ativar ap�s bloqueio + flag de motivo

- A��o de usu�rio agora alterna entre bloquear e **ativar** conforme status (`ACTIVE`/`INACTIVE`/`BLOCKED`).
- API de status passou a aceitar reativa��o (`ACTIVE`) mantendo motivo obrigat�rio para bloquear/inativar.
- Tabela de usu�rios passou a exibir flag com `statusReason` (hover/click), no mesmo padr�o visual da observa��o das comiss�es.
...
- Com isso, a flag de motivo desaparece ap�s reativa��o, mantendo apenas motivos vigentes de bloqueio/inativa��o.
...
- Ajustado contraste de t�tulo e textos auxiliares (`.muted`) dentro de `modal-dialog` para melhorar leitura no modo claro.
- Mantida paridade no modo escuro com regra espec�fica para `body[data-theme="dark"] .modal-dialog .muted`.
...
- Modo escuro mantido sem mudan�as.
...
- Corrigido content-modal__description no modo claro para cinza escuro, mantendo escuro sem altera��es.
- Log: $log.
...
## 2026-04-14 - E-mail de ativa��o com dados de acesso

- Ajustado e-mail enviado na aprova��o do usu�rio para mensagem de ativa��o com URL de acesso, e-mail e refer�ncia � senha cadastrada.
- Log: $log.
...
## 2026-04-14 - Recupera��o de senha em fluxo sequencial

- Refatorado /ativar para recupera��o de senha em 3 etapas: e-mail ? c�digo ? nova senha.
